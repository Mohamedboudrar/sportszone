...
?>
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <h3 class="heading-92913 text-black">Jet Details</h3>
                <p><strong>Jet Name:</Strong>  <?php echo $result['BoatName'];?></p>
                <p><strong>Jet Size:</Strong>  <?php echo $result['Size'];?></p>
                <p><strong>Capacity of Jet:</Strong>  <?php echo $result['Capacity'];?> persons.</p>
              ...
              <p><strong>Destination: <?php echo $result['Destination'];?></strong> </p>
                ...
                <p><strong>Price: <?php echo $result['Price'];?> (per person)</strong> </p>
