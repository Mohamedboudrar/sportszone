...
if(strlen($_SESSION['aid']) == 0) { 
    ...
    if(isset($_POST['submit'])) {
        ...
        // Update query
        $query = "UPDATE tblboat SET BoatName='$boatname',Capacity='$capacity',Price='$price', Description='$description', Location='$location', AddedBy='$addedby' WHERE ID = $eid";
        ...
        if($result) {
            echo "<script>alert('Zone detail updated successfully.');</script>";
...
<head>
  ...
  <title>SportsZone  | Update Zone</title>
...
<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description of Zone" required><?php echo $result['Description'];?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFullname">Location</label>
                    <textarea class="form-control" id="location" name="location" placeholder="Enter loaction of Zone" required><?php echo $result['Location'];?></textarea>
                  </div>
<?php } ?>
