...
if($query){
echo "<script>alert('Jet detail added successfully.');</script>";
 ...
 <?php include_once("includes/sidebar.php");?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Jet</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
   ...
   <div class="form-group">
                    <label for="exampleInputFullname">Name of Jet</label>
                    <input type="text" class="form-control" id="Boatname" name="Boatname" placeholder="Enter Name of Jet" required>
                  </div>
...
<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Enter Capacity of Jet" required>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description of Jet" required></textarea>
                  </div>
