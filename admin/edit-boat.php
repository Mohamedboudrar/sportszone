...
$route=$_POST['route'];
        ...
        if($result) {
            echo "<script>alert('Jet detail updated successfully.');</script>";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Jet</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Jet Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
