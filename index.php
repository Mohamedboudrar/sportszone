...
<head>
  <title>Private Jet Booking System || Home Page</title>
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 ml-auto text-right" data-aos="fade-up">
              <h1>Business? Trip with Family?</h1>
      ...
      <div class="intro-section" style="background-image: url('images/hero1.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 mx-auto text-center" data-aos="fade-up">
              <h1>We make you fly</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p>Welcome to WeFly, your trusted partner in luxury and convenience. We specialize in providing seamless private jet reservation services tailored to your unique needs. Whether for business or leisure, we ensure your journey is comfortable, secure, and tailored to perfection.</p><br>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="service-29283">
          <span class="wrap-icon-39293">
            <img src="images/hands.svg" alt="Image" class="">
          </span>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="service-29283">
          <span class="wrap-icon-39293">
            <img src="images/captain.svg" alt="Image" class="">
          </span>
          <h3>Good Captain</h3>
        </div>
      </div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/hero2.jpg');">
      <div class="container">
        <div class="row">
          <div class="col">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <span class="text-serif text-primary">Destinations</span>
